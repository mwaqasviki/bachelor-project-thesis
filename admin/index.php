...
$count_total_earnings = $row['Total'];
 ...
 $count_chef = mysqli_num_rows($run_chef);
...
if(isset($_GET['view_hotdeals'])){

    include("view_hotdeals.php");
    
}
if(isset($_GET['edit_hotdeals'])){

    include("edit_hotdeals.php");
...
if(isset($_GET['predicted_food'])){

    include("prediction_food.php");
