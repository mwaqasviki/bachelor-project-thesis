...
$update_product = "update food set title='$food_title',description='$food_desc',price='$food_price',image='$food_img1',category_id='$food_cat',special='$food_sp',recommend='$featured',featured='$featured',active='$active',cook_id='$chef_id'  where id='$f_id'";
