...
<div class="huge"> <?php echo $count_foods; ?> </div>
        ...
        <div class="col-lg-3 col-md-6"><!-- col-lg-3 col-md-6 Starts -->
            ...
            <div class="col-lg-3 col-md-6"><!-- col-lg-3 col-md-6 Starts -->
                ...
                <div class="col-lg-3 col-md-6"><!-- col-lg-3 col-md-6 Starts -->
                    ...
                    <div class="huge"> <?php echo $count_chef; ?> </div>
...
$get_food = "select title from food where id='$food_id' ";

$run_pro = mysqli_query($con,$get_food);
$row_food = mysqli_fetch_array($run_pro);
