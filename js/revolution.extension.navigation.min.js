    ...
    resizeThumbsTabs: function (t, e) {
      if (
        ...
        if (
          ...
          p(o) &&
            (e || o.width > o.min_width) &&
            n(i, a, t.c, o, t.slideamount, "thumb"),
          p(s) && e)
        ) {
          ...
          d.find(".tp-bullet").each(function (t) {
            var e = jQuery(this),
              i = t + 1,
              a =
                e.outerWidth() + parseInt(void 0 === s.space ? 0 : s.space, 0),
              n =
                e.outerHeight() + parseInt(void 0 === s.space ? 0 : s.space, 0);
    ...
    manageNavigation: function (t) {
      ...
      p(t.navigation.bullets) &&
        ...
        p(t.navigation.thumbnails) &&
          b(t.c.parent().find(".tp-thumbs"), t.navigation.thumbnails),
        p(t.navigation.tabs) &&
          b(t.c.parent().find(".tp-tabs"), t.navigation.tabs),
  ...
  var a = function (t, e) {
      ...
      var o = i.parent().find(".tp-" + r + "s"),
        ...
        c =
          "vertical" === a.direction
            ? { width: l + "px" }
            : { height: h + "px" };
      e.add(punchgs.TweenLite.set(o, c)),
        e.add(punchgs.TweenLite.set(s, { width: p + "px", height: u + "px" })),
        ...
        t.on("mousewheel DOMMouseScroll", function (o) {
          ...
          return (
            "carousel" != i.navigation.mouseScrollNavigation
              ? ("reverse" !== i.navigation.mouseScrollReverse &&
                  ((c > 0 && s.pixelY > 0) ||
                    (g < jQuery(window).height() && s.pixelY < 0)) &&
                  (u = !0),
                "reverse" === i.navigation.mouseScrollReverse &&
                  ((0 > c && s.pixelY < 0) ||
                    (g > jQuery(window).height() && s.pixelY > 0)) &&
                  ...
                  if (
                    ((r.slide_offset =
                      "off" === r.infinity
                        ...
                        : e.simp(r.slide_globaloffset + s, r.maxwidth)),
                    "off" === r.infinity)
                  ) {
                    var b =
                    ...
                    !(0 > b || b > a.slideamount - 1)
                      ? b >= 0 &&
                        b <= a.slideamount - 1 &&
                        ((b >= 0 && s > r.overpull) ||
                          (b <= a.slideamount - 1 && s < r.overpull)) &&
                        (r.overpull = 0)
                      : (r.overpull = s),
                      (r.slide_offset =
                        0 > b
    ...
    f = function (t, e) {
      var i = t.outerHeight(!0),
        a =
          (t.outerWidth(!0),
          void 0 == e.opt ? 0 : 0 == e.opt.conh ? e.opt.height : e.opt.conh),
        n =
          "layergrid" == e.container
            ? "fullscreen" == e.opt.sliderLayout
              ? e.opt.height / 2 -
                (e.opt.gridheight[e.opt.curWinRange] * e.opt.bh) / 2
              : "on" == e.opt.autoHeight ||
                (void 0 != e.opt.minHeight && e.opt.minHeight > 0)
    ...
    m = function (t, e) {
      var i = (t.outerHeight(!0), t.outerWidth(!0)),
        a =
          "layergrid" == e.container
            ? "carousel" === e.opt.sliderType
              ? 0
              : e.opt.width / 2 -
                (e.opt.gridwidth[e.opt.curWinRange] * e.opt.bw) / 2
            : 0,
        n =
          "left" === e.h_align
      ...
      if (
        ...
        o > a && "outer-left" !== e.position && "outer-right" !== e.position
          ...
          : (punchgs.TweenLite.set(t, { maxWidth: o + "px" }),
            punchgs.TweenLite.set(d, { maxWidth: o + "px" })),
          s + 2 * r > n &&
          ...
          "outer-top" !== e.position
            ...
            : (punchgs.TweenLite.set(t, { maxHeight: s + "px" }),
              punchgs.TweenLite.set(d, { maxHeight: s + "px" })),
          "outer-left" !== e.position &&
            "outer-right" !== e.position &&
            ((l = 0), (h = 0)),
    ...
    w = function (t, e, i, a) {
      ...
      "vertical" === e.direction
        ? (s.css({ top: (d - 1) * h + "px", left: "0px" }),
          n.css({
            height: (d - 1) * h + s.outerHeight(),
            width: s.outerWidth(),
          }))
