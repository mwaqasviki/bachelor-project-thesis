...
!(function (e) {
  ...
  jQuery.extend(!0, a, {
          ...
          jQuery("head")
            ...
            .each(function () {
              jQuery(this).attr("src") ==
                i + "://f.vimeocdn.com/js/froogaloop2.min.js" && (r = !1);
            }),
    ...
    manageVideoLayer: function (e, o, n, s) {
      var u = e.data("videoattributes"),
        ...
        v = e.data("vimeoid"),
        c =
          "auto" === e.data("videopreload") ||
          "canplay" === e.data("videopreload") ||
          "canplaythrough" === e.data("videopreload") ||
          "progress" === e.data("videopreload")
            ? "auto"
            : e.data("videopreload"),
        g = e.data("videomp4"),
        f = e.data("videowebm"),
        ...
        x =
          "html5" == k && 0 == e.find(T).length
            ? "html5"
            : "youtube" == k && 0 == e.find("iframe").length
            ? "youtube"
            : "vimeo" == k && 0 == e.find("iframe").length
            ? "vimeo"
            : "none";
      switch ((e.data("videotype", k), x)) {
        case "html5":
          ...
          var T = "video";
          "html5" == e.data("audio") &&
            ((T = "audio"), e.addClass("tp-audio-html5"));
          var L =
            "<" +
            T +
          ...
          "auto" == c && (o.mediapreload = !0),
            void 0 != f &&
              ...
              (L = L + '<source src="' + f + '" type="video/webm" />'),
            void 0 != g &&
              (L = L + '<source src="' + g + '" type="video/mp4" />'),
            void 0 != m &&
              (L = L + '<source src="' + m + '" type="video/ogg" />'),
            (L = L + "</" + T + ">");
          var V = "";
          ("true" === y || y === !0) &&
            (V =
  ...
  var d = function (e, t, a) {
    ...
    r = function (e, d, r) {
      ...
      if (
        ...
        switch (e.data("videotype")) {
                  ...
                  if (i.data == YT.PlayerState.PLAYING)
                    punchgs.TweenLite.to(e.find(".tp-videoposter"), 0.3, {
                      ...
                      d.globalmute === !0
                        ? m.mute()
                        : (m.unMute(),
                          m.setVolume(parseInt(e.data("volume"), 0) || 75)),
                      (d.videoplaying = !0),
                      u(e, d),
          ...
          case "vimeo":
            for (
              var y, h = l.attr("src"), b = {}, w = h, k = /([^&=]+)=([^&]*)/g;
              (y = k.exec(w));

            )
              b[decodeURIComponent(y[1])] = decodeURIComponent(y[2]);
            h =
              void 0 != b.player_id
                ? h.replace(b.player_id, v)
                : h + "&player_id=" + v;
            try {
    ...
    s = function () {
      ...
      var t = 5;
      return (
        e.browser.webkit && /Apple Computer/.test(navigator.vendor) && (t = 42),
        screen.width == window.innerWidth &&
          Math.abs(screen.height - window.innerHeight) < t
      );
    },
    l = function (e, r, l) {
      if (i && 1 == e.data("disablevideoonmobile")) return !1;
      ...
      void 0 != b &&
        ...
        void 0 != w &&
          d(w, "click", function () {
            0 == g.muted
              ? ((g.muted = !0), (w.innerHTML = "Unmute"))
              : ((g.muted = !1), (w.innerHTML = "Mute"));
          }),
        void 0 != k &&
          k &&
          d(k, "click", function () {
        ...
        d(g, "play", function () {
          ...
          u(e, r),
            y && "audio" != i
              ...
              : ((r.videoplaying = !1),
                "audio" != i && r.c.trigger("starttimer"),
                r.c.trigger(
                  "revolution.slide.onvideostop",
                  o(g, "html5", e.data())
                )),
          ...
          void 0 != d && (d.innerHTML = "Pause"),
            void 0 != n && g.muted && (n.innerHTML = "Unmute"),
            a.toggleState(e.data("videotoggledby"));
        }),
        d(g, "pause", function () {
