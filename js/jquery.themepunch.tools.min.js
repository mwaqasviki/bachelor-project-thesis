        ...
        if (this._timeline) {
          ...
          this._gc && this._enabled(!0, !1),
            (this._totalTime !== t || 0 === this._duration) &&
              (z.length && V(), this.render(t, e, !1), z.length && V());
        }
        return this;
      }),
                ...
                n
                  ? "string" != typeof n
                    ? n.length &&
                      ...
                      : ((this._siblings[r] = W(n, this, !1)),
                        1 === l &&
                          this._siblings[r].length > 1 &&
                          Y(n, this, null, 1, this._siblings[r]))
                    : ((n = a[r--] = I.selector(n)),
        ...
        for (n = r.length; --n > -1; )
          (o = r[n]) === e ||
            ...
            (o._timeline !== e._timeline
              ? ((h = h || Z(e, 0, m)), 0 === Z(o, h, m) && (f[c++] = o))
              : u >= o._startTime &&
                o._startTime + o.totalDuration() / o._timeScale > u &&
                (((m || !o._initted) && 2e-10 >= u - o._startTime) ||
                  (f[c++] = o)));
        for (n = c; --n > -1; )
          if (
            ((o = f[n]),
    ...
    (n._init = function () {
      ...
      (n._initProps = function (e, i, s, r) {
        ...
        for (n in this.vars)
          if (((_ = this.vars[n]), M[n]))
            ...
            Q[n] &&
            (l = new Q[n]())._onInitTween(e, this.vars[n], this)
          ) {
            for (
              this._firstPT = h =
                {
      ...
      (I.getTweensOf = function (t, e) {
        ...
        if ((c(t) || E(t)) && "number" != typeof t[0]) {
          ...
          for (s = W(t).concat(), i = s.length; --i > -1; )
        ...
        K = function (t, e) {
          ...
          if ((e = e || H(t, null)))
            if ((i = e.length))
              for (; --i > -1; )
                (s = e[i]),
                  (-1 === s.indexOf("-transform") || Se === s) &&
                    (n[s.replace(O, k)] = e.getPropertyValue(s));
            else
              for (i in e)
      ...
      var ce = function (t, e, i, r) {
        ...
        ge = (a.parseComplex = function (t, e, i, r, s, n, a, o, l, h) {
          ...
          for (
            ...
            if (((p = O[f]), (d = C[f]), (x = parseFloat(p)), x || 0 === x))
              a.appendXtra(
                "",
                x,
                se(d, x),
      ...
      var we,
        ...
        ke = (E.Transform = function () {
          (this.perspective = parseFloat(a.defaultTransformPerspective) || 0),
            (this.force3D =
              a.defaultForce3D !== !1 && Ce ? a.defaultForce3D || "auto" : !1);
        }),
        ...
        Xe = function (t, e) {
          ...
          if (
            (Pe
              ? (r = Q(t, Se, null, !0))
              : t.currentStyle &&
                ((r = t.currentStyle.filter.match(A)),
                (r =
                  r && 4 === r.length
                    ? [
                        r[0].substr(4),
            ...
            return Fe;
          for (
            s = (r || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], ve = s.length;
            --ve > -1;
        ...
        ze = (E.getTransform = function (t, i, r, n) {
          ...
          var o,
            ...
            m = 1e5,
            g = Ce
              ? parseFloat(Q(t, Oe, i, !1, "0 0 0").split(" ")[2]) ||
                _.zOrigin ||
                0
              : 0,
            v = parseFloat(a.defaultTransformPerspective) || 0;
          if (
            ((_.svg = !(!t.getBBox || !Ne(t))),
            _.svg &&
              (Le(
                t,
                Q(t, Oe, s, !1, "50% 50%") + "",
            ...
            if (16 === o.length) {
              ...
              _.zOrigin &&
                ...
                E &&
                  ...
                  (S = x)),
                _.rotationX &&
                  Math.abs(_.rotationX) + Math.abs(_.rotation) > 359.9 &&
                  ((_.rotationX = _.rotation = 0), (_.rotationY += 180)),
                ...
                (_.z = B),
                _.svg &&
                  ((_.x -= _.xOrigin - (_.xOrigin * P - _.yOrigin * k)),
              ...
              (_.x = o[4] || 0),
                ...
                Ce &&
                  ...
                  (_.scaleZ = 1)),
                _.svg &&
                  ((_.x -= _.xOrigin - (_.xOrigin * W + _.yOrigin * j)),
          ...
          E.setTransformRatio =
            function (t) {
                  ...
                  C || S.skewX || z
                    ? ((C *= L),
                      ...
                      z &&
                        ...
                        (F +=
                          S.yOrigin -
                          (S.xOrigin * s + S.yOrigin * n) +
                          S.yOffset),
                        we &&
                          (S.xPercent || S.yPercent) &&
                          ((d = this.t.getBBox()),
                          (N += 0.01 * S.xPercent * d.width),
                          (F += 0.01 * S.yPercent * d.height)),
                        (d = 1e-6),
                        d > N && N > -d && (N = 0),
                        d > F && F > -d && (F = 0)),
                      (x =
              ...
              (h = 1),
                ...
                1 !== A && ((e *= A), (s *= A), (o *= A), (u *= A)),
                (p || z) &&
                  (p && ((N += r * -p), (F += a * -p), (X += h * -p + p)),
                  z &&
                    ((N +=
                      S.xOrigin - (S.xOrigin * e + S.yOrigin * i) + S.xOffset),
                    (F +=
                      S.yOrigin - (S.xOrigin * s + S.yOrigin * n) + S.yOffset)),
                  d > N && N > -d && (N = w),
                  d > F && F > -d && (F = w),
                  d > X && X > -d && (X = 0)),
                (x =
            ...
            parser: function (t, e, i, r, n, o, l) {
              ...
              if (
                ...
                (c = B.style),
                  ...
                  null != b.xPercent &&
                    (u.xPercent = ne(b.xPercent, h.xPercent)),
                  null != b.yPercent &&
                    (u.yPercent = ne(b.yPercent, h.yPercent));
                ...
                "string" == typeof b.x &&
                  -1 !== b.x.indexOf("%") &&
                  ((u.x = 0), (u.xPercent = ne(b.x, h.xPercent))),
                  "string" == typeof b.y &&
                    -1 !== b.y.indexOf("%") &&
                    ((u.y = 0), (u.yPercent = ne(b.y, h.yPercent))),
                  (u.rotation = ae(
                    "rotation" in b
                      ? b.rotation
                      : "shortRotation" in b
                  ...
                  (f = u.skewY - h.skewY) &&
                    ((u.skewX += f), (u.rotation += f));
              }
              for (
                Ce && null != b.force3D && ((h.force3D = b.force3D), (d = !0)),
                  ...
                  p =
                    ...
                    u.rotationY ||
                    u.perspective,
                  p || null == b.scale || (u.scaleZ = 1);
                --w > -1;

              )
                (i = be[w]),
                  (_ = u[i] - h[i]),
                  (_ > T || -T > _ || null != b[i] || null != F[i]) &&
                    ((d = !0),
              ...
              return (
                ...
                d &&
                  (r._transformType =
                    (h.svg && we) || (!p && 3 !== this._transformType) ? 2 : 3),
                n
              );
            },
            prefix: !0,
              ...
              this.p.indexOf("border") && (b[l] = q(b[l])),
                ...
                g !== v &&
                  ...
                  "%" === g
                    ...
                    : ((f = x + "px"), (u = T + "px")),
                  y &&
                    ((c = parseFloat(f) + p + g), (h = parseFloat(u) + p + g))),
          ...
          parser: function (t, e, i, r, n, a) {
            var o,
              ...
              m = this.format(
                (p
                  ? d
                    ? p.getPropertyValue(_ + "-x") +
                      " " +
                      p.getPropertyValue(_ + "-y")
                    : p.getPropertyValue(_)
            ...
            if (
              ...
              ((c = Q(t, "backgroundImage").replace(C, "")), c && "none" !== c)
            ) {
              for (
                o = m.split(" "),
                  l = g.split(" "),
        ...
        parser: function (t, e, i, r, n, a) {
          ...
          return (
            ...
            h &&
              ...
              (o = 0),
            W
              ? (n = new de(l, "opacity", o, e - o, n))
              : ((n = new de(l, "opacity", 100 * o, 100 * (e - o), n)),
                (n.xn1 = h ? 1 : 0),
                (l.zoom = 1),
                (n.type = 2),
      ...
      xe("className", {
        parser: function (t, e, r, n, a, o, l) {
          var h,
            ...
            d = t.style.cssText;
          if (
            ((a = n._classNamePT = new de(t, r, 0, 0, a, 2)),
            (a.setRatio = We),
            (a.pr = -11),
            (i = !0),
            (a.b = p),
                  ...
                  (m && P.test(_))
                    ? (m ||
                        ...
                        (_ =
                          ...
                          _.join(",") +
                          ")")),
                      (i = ge(v, a, c, _, !0, "transparent", i, 0, n)))
...
(function (t) {
  ...
  var e = t.GreenSockGlobals || t,
    ...
    y = function (t, e, i, s, o) {
        ...
        for (C = !L || (!D && !M), d = 0; A.length > d; d++) {
          for (
            ...
            "BR" !== _[y].nodeName &&
              ...
              L &&
                (0 === y &&
                  ((P.style.top = b._y + "px"), (P.style.left = E + x + "px")),
                (b.style.top = "0px"),
      ...
      L &&
        (Y > t.clientHeight &&
          ((t.style.height = Y - B + "px"),
          Y > t.clientHeight && (t.style.height = Y + N + "px")),
        q > t.clientWidth &&
          ((t.style.width = q - j + "px"),
