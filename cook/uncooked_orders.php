...
<html lang="en">
  ...
  <link href="font-awesome/css/font-awesome.min.css" rel="stylesheet">
    ...
    <div class="d-flex justify-content-center" >
        <div class="m-3">
        <a href="cooked_orders.php" class="btn btn-success p-2">Cooked Orders</a>
        </div>
...
$get_orders = "SELECT order_id,food_id, qty ,table_no,cook_status FROM pending_orders WHERE order_status='Complete' AND Cook_status='Uncooked' ORDER BY order_date ASC";
...
$food_image = $row_foods['image'];
				          ...
				          <td><?php echo $cook_status; ?></td>
						      <td>
                              <a href="complete_order.php?order_id=<?php echo $order_id; ?>" class="btn btn-primary">Order Cooked</a>
                              </td>
						    </tr>
